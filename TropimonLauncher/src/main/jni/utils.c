...
JNIEXPORT void JNICALL Java_com_hazender_tropimonlauncher_bridge_ZLBridge_setLdLibraryPath(JNIEnv *env, jclass clazz, jstring ldLibraryPath) {
...
JNIEXPORT jboolean JNICALL Java_com_hazender_tropimonlauncher_bridge_ZLBridge_dlopen(JNIEnv *env, jclass clazz, jstring name) {
...
JNIEXPORT jint JNICALL Java_com_hazender_tropimonlauncher_bridge_ZLBridge_chdir(JNIEnv *env, jclass clazz, jstring nameStr) {
