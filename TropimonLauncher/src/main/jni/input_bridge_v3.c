...
jint JNI_OnLoad(JavaVM* vm, __attribute__((unused)) void* reserved) {
    if (pojav_environ->dalvikJavaVMPtr == NULL) {
        ...
        //ZL Invoker
        pojav_environ->class_ZLInvoker = (*pojav_environ->dalvikJNIEnvPtr_ANDROID)->NewGlobalRef(pojav_environ->dalvikJNIEnvPtr_ANDROID,(*pojav_environ->dalvikJNIEnvPtr_ANDROID) ->FindClass(pojav_environ->dalvikJNIEnvPtr_ANDROID, "com/hazender/tropimonlauncher/bridge/ZLNativeInvoker"));
...
static bool tryCriticalNative(JNIEnv *env) {
    ...
    jclass criticalNativeTest = (*env)->FindClass(env, "com/hazender/tropimonlauncher/game/input/CriticalNativeTest");
