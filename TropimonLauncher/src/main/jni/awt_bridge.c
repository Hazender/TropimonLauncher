...
jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    if (dalvikJavaVMPtr == NULL) {
        ...
        class_ZLInvoker = (*env)->NewGlobalRef(env,(*env)->FindClass(env, "com/hazender/tropimonlauncher/bridge/ZLNativeInvoker"));
...
JNIEXPORT void JNICALL Java_com_hazender_tropimonlauncher_bridge_ZLBridge_sendInputData(JNIEnv* env, jclass clazz, jint type, jint i1, jint i2, jint i3, jint i4) {
...
JNIEXPORT jintArray JNICALL Java_com_hazender_tropimonlauncher_bridge_ZLBridge_renderAWTScreenFrame(JNIEnv* env, jclass clazz /*, jobject canvas, jint width, jint height */) {
...
JNIEXPORT void JNICALL Java_com_hazender_tropimonlauncher_bridge_ZLBridge_clipboardReceived(JNIEnv *env, jclass clazz, jstring clipboardData, jstring clipboardDataMime) {
...
Java_com_hazender_tropimonlauncher_bridge_ZLBridge_moveWindow(JNIEnv *env, jclass clazz, jint xoff, jint yoff) {
    if (runtimeJNIEnvPtr_INPUT == NULL) {
        if (runtimeJavaVMPtr == NULL) {
            return;
        } else {
