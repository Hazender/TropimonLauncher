...
package com.hazender.tropimonlauncher.components.jre

import android.content.Context
import android.content.res.AssetManager
import com.hazender.tropimonlauncher.TLApplication
import com.hazender.tropimonlauncher.components.AbstractUnpackTask
        ...
        runCatching {
            RuntimesManager.installRuntimeBinPack(
                ...
                platformBinsInputStream = assetManager.open(
                    jre.jrePath + "/bin-" + Architecture.archAsString(TLApplication.DEVICE_ARCHITECTURE) + ".tar.xz"
                ),
                name = jre.jreName,
