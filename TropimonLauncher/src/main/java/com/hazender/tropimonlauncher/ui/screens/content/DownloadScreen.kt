...
private fun TabMenu(
    ...
    val downloadsList = listOf(
        CategoryItem(backScreenViewModel.downloadModScreen, { CategoryIcon(Icons.Outlined.Extension, R.string.download_category_mod) }, R.string.download_category_mod),
