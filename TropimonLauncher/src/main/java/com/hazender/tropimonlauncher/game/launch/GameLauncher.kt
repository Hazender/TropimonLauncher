...
import com.hazender.tropimonlauncher.TLApplication
import com.hazender.tropimonlauncher.bridge.LoggerBridge.append
import com.hazender.tropimonlauncher.bridge.LoggerBridge.appendTitle
import com.hazender.tropimonlauncher.bridge.ZLBridge
import com.hazender.tropimonlauncher.context.readAssetFile
...
import com.hazender.tropimonlauncher.game.account.offline.OfflineYggdrasilServer
...
import com.hazender.tropimonlauncher.game.plugin.renderer.RendererPluginManager
import com.hazender.tropimonlauncher.game.renderer.Renderers
import com.hazender.tropimonlauncher.game.support.touch_controller.ControllerProxy
import com.hazender.tropimonlauncher.game.version.installed.Version
import com.hazender.tropimonlauncher.game.version.installed.getGameManifest
...
import com.hazender.tropimonlauncher.utils.file.ensureDirectorySilently
...
import com.hazender.tropimonlauncher.utils.string.isEqualTo
...
class GameLauncher(
    ...
    private fun printLauncherInfo(
        ...
        append("Info: Architecture: ${Architecture.archAsString(TLApplication.DEVICE_ARCHITECTURE)}")
